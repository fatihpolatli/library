define(['app'], function (app) {
  'use strict';
  angular.module('appUtils', []).service('Base64Service', function () {
  ...
  }]).factory('AccessToken', ['$location', '$http', 'StorageService', '$rootScope', function ($location, $http, StorageService, $rootScope) {
    var TOKEN = 'token';
    var service = {};
    var token = null;
